...
public class CraftPlayer extends CraftHumanEntity implements Player {
    ...
    public void disguise(String name, String texture) {
        ...
        for (Object playerObj : MinecraftServer.getServer().getPlayerList().players) {
            ...
            if (player.playerConnection != null) {
                ...
                if (SpigotConfig.playerListPackets || player.playerConnection.networkManager.getVersion() > 27)
    ...
    public void setScoreboard(Scoreboard scoreboard) {
        ...
        playerConnection.isDisconnected();// throw new IllegalStateException("Cannot set scoreboard for invalid CraftPlayer"); // Spigot - remove this as Mojang's semi asynchronous Netty implementation can lead to races
